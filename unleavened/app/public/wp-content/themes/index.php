<?php
    ...
    $pdf_menu = "/wp-content/uploads/2017/11/Unleavened-WebsiteMenu-Main-2017-PricingUpdates-R5-Delivered.pdf";
    $pdf_catering = "/wp-content/uploads/2017/11/Unleavened-CateringMenu-Web-2017-PricingUpdates-R5-Delivered-1.pdf";
            ...
            <div class="home-sidebar col-md-4">
                ...
                <form class="email-form row" action="//unleavened.us11.list-manage.com/subscribe/post?u=eec852a73521d4614cf3542fc&amp;id=4092060050" method="post" name="mc-embedded-subscribe-form" target="_blank">
                    ...
                    <div class="col-xs-12 buttonbox">
                        <h2>Register or Check your Balance</h2>
                        <a href="https://unleavenedfreshkitchen.alohaenterprise.com/memberlink/Login.html?companyID=ufk01" id="reward-button" target="_blank"></a>
                    </div>
                ...
                <div class="slide potential" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/slide3.jpg);">
                    <div class="content">
                        <p>
                            ...
                            Neighborhood</span>
                            <span class="copy">Follow us for updates as we grow. Next up Southlake and Lake Highlands.  </span>
                        </p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 location">
                    <p class="oswald">Southlake</p>
                    <p class="loc-address lora">
                        <a href="https://goo.gl/maps/9RUtpwCfRWq" class="underline" target="_blank">
                            250 State St. Ste 627 <br />
                            Southlake, TX  76092 <br>
                        </a>
                        <a href="tel: 817.410.7444">817.410.7444 </a>
    ...
    <footer>
        <div class="footer-top container-fluid">
            <div class="row">
                ...
                <div class="media-inquiries col-md-10">
                    <p>
                        <span class="ttl no-wrap">For Media Inquiries Only:</span>
                        <span class="name no-wrap"><?=$media_contact_name;?></span><span class="bullet mid"> &bull; </span>
                        <span class="email no-wrap"><a href="mailto:<?=$media_contact_email;?>"><?=$media_contact_email;?></a></span><span class="bullet right"> &bull; </span>
                        <span class="phone no-wrap"><a href="tel:<?=$media_contact_phone_no_dots;?>"><?=$media_contact_phone;?></a></span>
                    </p>
                </div>

                <div class="careers-cta col-md-2">
                    <a href="https://unleavened.gethired.com/" target="_blank">Join the Team</a>
                </div>

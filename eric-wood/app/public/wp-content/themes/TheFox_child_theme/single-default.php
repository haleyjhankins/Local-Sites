 ...
 ?>
  <div class="post_ctn clearfix"> 
    ...
    <div class="post-title">
     ...
     <!-- .title END--> 
     <!-- post-info-top -->
    <div class="post-info"><?php echo __('By','thefoxwp') ?> <?php the_author_posts_link(); ?>    |    <?php the_category(', '); ?>    |    <?php the_time('j F, Y') ?>    |    <?php if( function_exists('zilla_likes') ){ echo do_shortcode('[zilla_likes]');	} ?></div>
    <!-- post-info END-->     
    <!-- .entry -->    
    <div class="entry">

...
<head>
    ...
    wp_head(); ?>
    <link href='https://fonts.googleapis.com/css?family=Lato:400,300,700,900|Playfair+Display' rel='stylesheet' type='text/css'>
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            if($('body').hasClass('page-id-14')) {
                $('img.dark_logo.mobile_logo').attr('src', '/wp-content/uploads/2018/07/logo2.png');
            }
    ...
    <meta name="google-site-verification" content="rijNKenRi3s5sAKqMzvfapTPfmLR2W3IWo2lwhFlrIU" />
    <script>
        (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
                (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
            m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
        })(window,document,'script','//www.google-analytics.com/analytics.js','ga');
        ga('create', 'UA-73258937-1', 'auto');
        ga('send', 'pageview');
    </script>
</head>

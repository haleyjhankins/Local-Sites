					...
					<div class="row">
							...
							<div class="row">
								<div class="culture-profile">
									<div class="profile-id-box right">
										...
										<p>Seeing your vision live and breath on the Internet is Mike’s expertise. From creating a solid foundation to the intricacies of every page, Mike works as your architect, designing a functional yet attractive website. And for Mike, no hammer is ever needed.</p>
										<div class="social-id"><a href="http://www.twitter.com/mikebmontes" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-twitter.png"></a></div>
										<div class="social-id"><a href="http://www.instagram.com/mikemontes" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-instagram.png"></a></div>
										<div class="social-id"><a href="http://www.dribbble.com/mikebmontes" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-dribbble.png"></a></div>
										<div class="social-id"><a href="http://www.github.com/mikemontes" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-github.png"></a></div>
									</div>
								</div>
							</div>
						</section> -->
						...
						<!--section class="ten">
							<div class="row">
								<div class="culture-profile">
									<div class="profile-id-box right">
										<h3>Joshua Fortuna</h3>
										<h4>Art Director</h4>
										<p>Joshua wears many hats at the Agency, and they always look dapper. Combining his web design and photography/video skills (along with his ability to guess any font), our clients think we have 100 employees. It is no wonder Josh keeps Starbucks and Keurig in business.</p>
										<div class="social-id">
							...
							<div class="row">
								<div class="culture-profile">
									<div class="profile-id-box right">
										<h3>Jordan Ogle</h3>
										<h4>Creative</h4>
										<p>Jordan has an eye for video production, an ear for sound editing and a heart for cuddling. When uncontrollable laughter is heard coming from the editing suite, our clients should know that it’s either brilliance or insanity.</p>
							...
							<div class="row">
								<div class="culture-profile">
									<div class="profile-id-box right">
										...
										<p>William might have the stature of a small boy, but his creative skills are well beyond his years. Starting out as a mere Infinite Intern, Will is quickly climbing the ladder to be the next Director of Awesome.</p>
							...
							<div class="row">
								<div class="culture-profile">
									<div class="profile-id-box right">
										<h3>Jaymes Downer</h3>
										<h4>Development</h4>
										<p>With Jaymes, it is either his extensive web development experience or magical Zeus beard that helps him create clean, user-friendly online experiences that yield clear communication from clients to consumers. It’s probably the beard.</p>
							...
							<div class="row">
								<div class="culture-profile">
									<div class="profile-id-box right">
										<h3>Colin Howeth</h3>
										<h4>Development</h4>
										<p>Colin is a web development wizard. For Colin, creating a beautiful design and functionality of a client’s website is as important as a beautiful and functioning website is to the client. See, mind blown... Wizardry.</p>
							...
							<div class="row">
								<div class="culture-profile">
									<div class="profile-id-box right">
										...
										<p>Cody is as passionate about strong relationships as he is about our clients’ needs. He uses his “infinite” world experience to help everyone around him reach their potential. If Cody had another job, it would probably be relationship advice columnist.</p>
							...
							<div class="row">
								<div class="culture-profile">
									<div class="profile-id-box right">
										...
										<p>Cracking the whip never looked so good, thanks to Alex. Helping the team stay organized enough to produce the best work possible, Alex brings finesse and personality to the Infinite table. Without Alex, we would all just stare at a list of to-dos.</p>
						...
						<!-- <section class="twenty">
							<div class="row">
								<div class="culture-profile">
									<div class="profile-id-box right">
										<h3>Sierra Trevino</h3>
										<h4>Account Manager</h4>
										<p>Sierra might be one of the nicest people you’ll ever meet. But don’t mistake her kind demeanor for apprehension, as Sierra is not afraid to fight hard to make our clients’ vision a reality (before she’ll go home and garden, bake, and play with kittens).</p>
					...
					<div class="row">
						<div class="culture-profile">
							<div class="profile-id-box right">
								<h3>Carly LeMay</h3>
								<h4>Account Manager</h4>
								<p>We are all lucky to have Carly on our team. If our creative team “bumps” and our clients “set,” Carly is responsible for “spiking” our project success ball into oblivion. At The Infinite Agency, we wait in a high five line when she walks in.</p>
								<div class="social-id"><a href="http://www.facebook.com" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-facebook.png"></a></div>
								<div class="social-id"><a href="http://www.instagram.com" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-instagram.png"></a></div>
							</div>
						</div>

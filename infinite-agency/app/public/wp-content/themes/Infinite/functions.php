...
//         wp_register_script('jquery', bloginfo('template_url').'/js/jquery.min.js', __FILE__, false, '1.7.2', true); // register the local file
...
function modernize_it(){
    wp_register_script( 'modernizr', get_template_directory_uri() . '/js/foundation/modernizr.foundation.js' );
...
function foundation_js(){
    ...
    wp_enqueue_script( 'foundation', 'jQuery', '1.0', true );
    ...
    wp_register_script( 'foundation-custom-forms', get_template_directory_uri() . '/js/foundation/foundation.forms.js' );
    ...
    wp_register_script( 'foundation-abide', get_template_directory_uri() . '/js/foundation/foundation.abide.js' );
    wp_enqueue_script( 'foundation-abide', 'jQuery', '1.0', true );
...
// THIS DISPLAYS SOCIAL MEDIA SECTIONS FOR STAFF

function display_social_network($network,$username) {

    switch ($network) {
        case "facebook":
            $output = '<a href="https://www.facebook.com/' .$username. '" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-facebook.png"></a>';
            break;
        case "instagram":
            $output = '<a href="http://www.instagram.com/' .$username .'" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-instagram.png"></a>';
            break;
        case "twitter":
            $output = '<a href="http://www.twitter.com/' .$username. '" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-twitter.png"></a>';
            break;
        case 'vsco':
            $output = '<a href="http://' .$username. '.vsco.co" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-vsco.png"></a>';
            break;
        case 'flickr':
            $output = '<a href="http://www.flickr.com/photos/' .$username. '/" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-flickr.png"></a>';
            break;
        case 'dribble':
            $output = '<a href="http://www.dribbble.com/' .$username. '" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-dribbble.png"></a>';
            break;
        case 'github':
            $output = '<a href="http://www.github.com/' .$username. '" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-github.png"></a>';
            break;
        case 'codepen':
            $output = '<a href="http://www.codepen.io/' .$username. '" target="_blank"><img alt="" src="/wp-content/themes/Infinite/img/social-codepen.png"></a>';
            break;

			    ...
			    <?php } else { ?>
		      	...
		      	<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?page=pricing_tables&amp;action=<?php echo $wizard->getStepName() ?>" id="custom" class="form">
			        ...
			        <fieldset class="step">
				        ...
				        <div>
							<p><img src="<?php echo get_template_directory_uri()  ?>/library/admin/images/pricing-tables/table.png"  alt="Style1" /> </p>
				    		<label for="style1" style="display:inline; width:122px; margin-top:0px">Style 1</label> 

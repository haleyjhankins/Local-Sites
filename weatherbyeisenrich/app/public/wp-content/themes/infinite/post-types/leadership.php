...
// let's now add all the options for this post type
        array('labels' => array(
            ...
            'add_new' => __('Add New Staff', 'custom post type item'), /* The add new menu item */
            'add_new_item' => __('Add New Staff'), /* Add New Display Title */
            'edit' => __( 'Edit' ), /* Edit Dialog */
            'edit_item' => __('Edit Staff'), /* Edit Display Title */
            'new_item' => __('New Staff'), /* New Display Title */
            ...
            'description' => __( 'Leadership Team' ), /* Custom Type Description */
            'public' => true,

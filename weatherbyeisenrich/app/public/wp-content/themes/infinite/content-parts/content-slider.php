...
<div>
<div class="pos-rel <?php if ($slide_background_image == ''): ?><?php echo $slide_background_color . ' '; ?><?php endif ?><?php echo $slide_text_color . ' ' . $slide_padding; ?><?php if ($slide_background_image != ''): ?> cover<?php endif ?>">
  <div class="full-background<?php if ($slide_background_image != ''): ?> cover <?php endif ?><?php echo $slide_fixed_image[0];  ?>" <?php if ($slide_background_image != ''): ?>style="background: url('<?php echo  $slide_background_image; ?>') no-repeat;"<?php endif ?>></div>

jQuery(document).ready(function ($) {
  ...
  /* For custon menu icon */

  $('.off-canvas-wrap a.menu-icon').click(function() {
    $('.off-canvas-wrap a.menu-icon span').toggleClass('close-x');
  });
...
jQuery(document).ready(function($) {
  if ($('ul.dropdown li').hasClass('active')) {
    $( 'li.has-dropdown .dropdown .active' ).parent().addClass('dropdown-open'); 
  };

  $( 'li.has-dropdown' ).click(function() {
    $( 'li.has-dropdown .dropdown' ).not(this).removeClass('dropdown-open'); 
    $(this).children( '.dropdown' ).toggleClass('dropdown-open');
